...
public class MultiTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    // Constants:
    private final static float kCubeScaleX = (0.354f + 0.03f) / 2.0f;
    private final static float kCubeScaleY = (0.055f + 0.03f) / 2.0f;
    private final static float kCubeScaleZ = (0.260f + 0.03f) / 2.0f;

    private final static float kBowlScaleX = 0.055f * 0.15f;
    private final static float kBowlScaleY = 0.055f * 0.15f;
    private final static float kBowlScaleZ = 0.055f * 0.15f;
